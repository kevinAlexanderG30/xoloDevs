            ...
            <View style={[GlobalStyleSheet.container,{flexGrow:1,paddingBottom:0,paddingHorizontal:30,paddingTop:0}]}>
                <View style={{}}>
                    <View style={{marginBottom:30}}>
                        <Text style={[styles.title1,{color:colors.title}]}>Crear tu cuenta</Text>
                        <Text style={[styles.title2, {color: colors.title }]}>
                            ¡Bienvenido! Ahora puedes comprar y vender ganado con soporte de transporte las 24 horas.
                        </Text>
                    </View>
                ...
                <View style={{marginTop:30}}>
                    ...
                    <View style={{marginTop:10}}>
                        <Text style={[styles.title2,{color:theme.dark ? 'rgba(255,255,255,0.5)':'rgba(0,0,0,0.5)',textAlign:'center'}]}>By XoloDevs “Crear Cuenta” you accept our <Text style={[styles.title1,{fontSize:14,color:COLORS.primary}]}>terms</Text> and <Text style={[styles.title1,{fontSize:14,color:COLORS.primary}]}>condition</Text></Text>
                    </View>
                </View>
            </View>
        </ScrollView>
